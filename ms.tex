...
%To illustrate, below we consider a model with a single neutrino mass 
%of 0.05 eV, and show that high precision measurements would allow 
...
%and $M_h=10^{13}M_\odot$ is the typical mass of a halo.  
